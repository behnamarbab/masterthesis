...
% // -T: Explain the fuzzers used in the experiment
...
% -T: Present the figures generated by Fuzzbench

% -T: Start a discussion about the reports

% -T: Present the execution metrics in graphs

% -T: Explain the rankings and compare the results
