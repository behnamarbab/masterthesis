...
% -T: Explain the execution time measurements

% -T: Explain the fuzzers used in the experiment

% -T: Explain the benchmarks used in the experiment

% -T: Explain the setup and execution of the experiment

% -T: Explain generated report

% -T: Explain the new feature, the execution time, and how we collect it
